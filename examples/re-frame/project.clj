(defproject cljs-pikaday-re-frame-example "0.1.0-SNAPSHOT"
  ...
  :ring {:handler cljs-pikaday-re-frame-example.handler/app
         :uberwar-name "cljs-pikaday-re-frame-example.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "cljs-pikaday-re-frame-example.jar"

  :main cljs-pikaday-re-frame-example.server
  ...
  :profiles {:dev {:repl-options {:init-ns cljs-pikaday-re-frame-example.repl
                   ...
                   :cljsbuild {:builds {:app {:source-paths ["env/dev/cljs"]
                                              :compiler {:main "cljs-pikaday-re-frame-example.dev"
                                                         :source-map true}}
}
}}
